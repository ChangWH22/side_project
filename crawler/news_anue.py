...
if __name__ =="__main__":
    df = anue_GET_NEWS_time("202105070830", "202105061330")
...
time.struct_time(tm_year=2021, tm_mon=1, tm_mday=15, tm_hour=0, tm_min=0, tm_sec=0, tm_wday=4, tm_yday=15, tm_isdst=0)
time.struct_time(tm_year=2021, tm_mon=1, tm_mday=25, tm_hour=23, tm_min=59, tm_sec=59, tm_wday=0, tm_yday=25, tm_isdst=0)
...
import time # 引入time
timeString = "2017-01-25 23:59:59" # 時間格式為字串
timeString = "2017-01-15 0:0:0"
